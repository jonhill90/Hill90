...
echo "================================"
echo "AI Service Deployment - ${ENV}"
echo "================================"
...
echo "Deploying AI service with encrypted secrets..."

sops exec-env "$SECRETS_FILE" '
  echo "Stopping existing AI container..."
...
echo "  - ai (AI service at ai.hill90.com)"
echo ""
