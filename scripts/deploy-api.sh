...
# Requires: infrastructure and auth deployed (networks must exist)
...
echo "================================"
echo "API Service Deployment - ${ENV}"
echo "================================"
...
echo "Deploying API service with encrypted secrets..."
...
echo "  - api (API Gateway at api.hill90.com)"
echo ""
